...
OIerDb 可以通过 [oier.baoshuo.dev](https://oier.baoshuo.dev) 在线使用。

## 开源许可

本项目基于 [AGPL-3.0](./LICENSE) 许可协议开源。

根据许可协议，您在自行部署本项目时，需要保留代码和页面中的作者信息。如果对本项目做出了修改，您需要以相同的许可证公开自部署版本的源代码。此外，您不得在自部署版本中使用本项目的名称、商标或徽标。
